  ...
  return (
    <Wrapper $isSide={isSide}>
      ...
      {helpUrl && (
        ...
        >
          <BubbleWrapper>
            <Button id="clickExchangeHelp" as="a" variant="subtle">
              {t("The problem with uniswap and all the clones does not seem obvious  as I had always assumed it would work the correct way,  before messing with the code.  I needed it to work correctly, and so I birthed this very much improved clone.  You can now have both TokenA  - TokenB and TokenB  - TokenA markets.  Let the fun begin.  Love you all,  twitter.com/@staccoverflow")}
            </Button>
