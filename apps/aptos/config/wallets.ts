...
export const wallets: WalletConfigV2<ConnectorNames>[] = [
  ...
  },
  {
    id: 'trustWallet',
    title: 'Trust Wallet',
    icon: 'https://atfault.dev/images/wallets/trust.png',
    get installed() {
      return typeof window !== 'undefined' && isIOS && Boolean(window.aptos) && Boolean((window.aptos as any)?.isTrust)
    },
    deepLink: isIOS
      ? 'https://link.trustwallet.com/open_url?coin_id=637&url=https://aptos.atfault.dev/'
      : undefined,
  ...
  },
  {
    id: 'safePal',
    title: 'SafePal',
    icon: 'https://atfault.dev/images/wallets/safepal.png',
    get installed() {
